...
public class RetoCultural extends Activity implements View.OnClickListener {
    ...
    private ArrayAdapter<Recompensa> adapter;
    ...
    public void loadItems(){
       // dt.add(new Recompensa("nombre 1",R.drawable.busto ));
       // dt.add(new Recompensa("nombre 2",R.drawable.busto ));
       // dt.add(new Recompensa("nombre 3",R.drawable.busto ));
       // dt.add(new Recompensa("nombre 4",R.drawable.busto ));
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.buttonResponse:
                ...
                Toast.makeText(RetoCultural.this,"Tu respuesta es "+construyeRespuesta,Toast.LENGTH_LONG).show();
